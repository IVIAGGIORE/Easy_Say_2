...
public class RecognitionFragment extends Fragment {
    ...
    OnMessageRecognition onMessageRecognition;

    public  interface  OnMessageRecognition
    {
    ...
    public void onAttach(Context context){
        ...
        try{
            onMessageRecognition = (RecognitionFragment.OnMessageRecognition) activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnStartRec = v.findViewById(R.id.btnStartRec);
        btnStopRec = v.findViewById(R.id.btnStopRec);
        btnStartRec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onMessageRecognition.НачатьРаспознавание();
            }
        });
        btnStopRec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onMessageRecognition.ОкончитьРаспознавание();
            }
        });
